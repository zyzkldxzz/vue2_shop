  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="address in tradeInfo.userAddressList" :key="address.id">
        ...
        <p @click="changeDefault(address,tradeInfo.userAddressList)">
...
import {mapState} from 'vuex'
  export default {
    ...
    computed:{
      ...
      defaultAddress(){
        if(this.tradeInfo.userAddressList){
          return this.tradeInfo.userAddressList.find(item =>item.isDefault==1)||{}
        }
      }
    },
    mounted(){
    ...
    methods:{
      ...
      async submitOrder(){
        ...
        //   this.tradeId = result.data
          this.tradeId = '10052'
          this.$router.push('/pay?orderId=' + this.tradeId)
        // }else{
